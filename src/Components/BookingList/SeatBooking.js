    ...
    return (
      <div>
        ...
        <DrawGrid
          ...
          handleSubmitted={ this.handleSubmitted.bind(this)}
        />
      </div>
    )
  }
  ...
  render() {
    return (
      <div className="container">
        ...
        <button type="button" className="btn-success btn margin" onClick={() => this.props.handleSubmitted()}>Confirm Booking</button>
      </div>
      )
    }
